package net.lldv.experiencebank.components.forms.simple;
...
import net.lldv.experiencebank.components.forms.FormHandler;
...
public class SimpleForm {
    ...
    public void send(Player player) {
        ...
        Server.getInstance().getScheduler().scheduleDelayedTask(ExperienceBank.getInstance(), () -> player.sendExperience(player.getExperience()), 20);
    }
