package net.lldv.experiencebank.components.tools;
...
public class Language {
    ...
    public static void init() {
        messages.clear();
        ExperienceBank.getInstance().saveResource("messages.yml");
        Config m = new Config(ExperienceBank.getInstance().getDataFolder() + "/messages.yml");
